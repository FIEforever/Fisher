package com.doyoteam.drawables;
...
public class LollipopDrawablesCompat {
    ...
    private static final LongSparseArray<WeakReference<Drawable.ConstantState>> sDrawableCache =
            new LongSparseArray<>();
     ...
     */
    public static Drawable createFromResourceStream(Resources res, TypedValue value, InputStream
            is, String srcName) {
     ...
     */
    public static Drawable createFromXml(Resources r, XmlPullParser parser) throws
     ...
     * <a href="{@docRoot}guide/topics/resources/drawable-resource.html">Drawable Resources</a>.
     */
    public static Drawable createFromXml(Resources r, XmlPullParser parser, Resources.Theme
            theme) throws XmlPullParserException, IOException {
        AttributeSet attrs = Xml.asAttributeSet(parser);

        int type;
        while ((type = parser.next()) != XmlPullParser.START_TAG && type != XmlPullParser
                .END_DOCUMENT) {
            // Empty loop
        }
     ...
     */
    public static Drawable createFromXmlInner(Resources r, XmlPullParser parser, AttributeSet
            attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
    ...
    private static Drawable getCachedDrawable(LongSparseArray<WeakReference<Drawable
            .ConstantState>> cache, long key, Resources res) {
    ...
    private static void cacheDrawable(TypedValue value, Resources resources, Resources.Theme
            theme, boolean isColorDrawable, long key, Drawable drawable,
    ...
    private static Drawable loadDrawableForCookie(TypedValue value, int id, Resources res,
                                                  Resources.Theme theme) {
        if (value.string == null) {
            throw new Resources.NotFoundException("Resource \"" + res.getResourceName(id) + "\" " +
                    "(" + Integer.toHexString(id) + ")  is not a Drawable (color or path): " +
                    value);
        }
        ...
        if (file.endsWith(".xml")) {
            try {
                ...
                Log.w(LollipopDrawablesCompat.class.getSimpleName(), "Failed to load drawable " +
                        "resource, " + "using a fallback...", e);
    ...
    static class BaseDrawableImpl implements IDrawable {
        ...
        public boolean canApplyTheme(Drawable drawable) {
            return drawable instanceof LollipopDrawable && ((LollipopDrawable) drawable)
                    .canApplyTheme();
        }

        @Override
        public void inflate(Drawable drawable, Resources r, XmlPullParser parser, AttributeSet
                attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
