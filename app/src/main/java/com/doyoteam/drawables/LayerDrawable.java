...
public class LayerDrawable extends LollipopDrawable implements Drawable.Callback {
    ...
    private void updateLayerFromTypedArray(Theme theme, TypedValue[] extracted, ChildDrawable layer, TypedArray a) {
        ...
        layer.mInsetL = TypedArrayCompat.getDimensionPixelOffset(theme, a, extracted, R.styleable
                .LayerDrawableItem_android_left, layer.mInsetL);
        layer.mInsetT = TypedArrayCompat.getDimensionPixelOffset(theme, a, extracted, R.styleable
                .LayerDrawableItem_android_top, layer.mInsetT);
        layer.mInsetR = TypedArrayCompat.getDimensionPixelOffset(theme, a, extracted, R.styleable
                .LayerDrawableItem_android_right, layer.mInsetR);
        layer.mInsetB = TypedArrayCompat.getDimensionPixelOffset(theme, a, extracted, R.styleable
                .LayerDrawableItem_android_bottom, layer.mInsetB);

        layer.mId = TypedArrayCompat.getResourceId(theme, a, extracted, R.styleable
                .LayerDrawableItem_android_id, layer.mId);
